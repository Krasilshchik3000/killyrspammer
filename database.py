...
Считай сообщение спамом ТОЛЬКО если выполняется хотя бы одно условие:
...
ВОЗМОЖНО_СПАМ — только если есть СЕРЬЁЗНЫЕ основания подозревать спам, но нет уверенности.

Что НЕ является спамом (обязательные исключения):

- Обсуждение цен, зарплат, налогов, стоимости жизни, штрафов, аренды — это обычный разговор, НЕ спам.
- Упоминание сумм денег в контексте новостей, историй, бытовых обсуждений — НЕ спам.
- Мнения, шутки, эмоциональные реакции, короткие реплики — НЕ спам.
- Ответы на чужие сообщения в рамках обсуждения — НЕ спам.
- Ссылки на официальные/новостные ресурсы без признаков мошенничества — НЕ спам.
- Короткие сообщения без явных признаков спама — НЕ спам.
- Аббревиатуры, названия организаций и партий — НЕ спам.

Правило по умолчанию: если сомневаешься — это НЕ_СПАМ. Лучше пропустить спам, чем забанить обычного человека.
